function infoHandler(){
    ...
    christmasCard.innerHTML = (`<div class="card text-white bg-dark justify-content-center align-items-center">
                                    <img src="https://images.unsplash.com/photo-1481481525014-91e77115eace?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1084&q=80" style="max-width: 15rem; class="card-img-top-1" alt="Imagen de Papá Noel">
                                    <div class="card-body">
